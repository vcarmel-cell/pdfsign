// קובץ זה נטען עם ‎?v=1‎ ב-demo.html/fill.html/admin.html (מטמון דפדפן/GitHub
// Pages ל-10 דקות גרם בעבר לטעינת גרסה ישנה אחרי דיפלוי טרי, במיוחד ב-Safari
// נייד) - יש להעלות את המספר בכל שינוי בקובץ הזה כדי לאלץ טעינה מחדש.
